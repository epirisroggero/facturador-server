...
public class RemoteServiceHandler {
			...
			for (DocumentoDTO documentoDTO : documentos) {
				...
				if (documentoNCF != null && documentoNCF.getProcessId() != null && documentoNCF.isEmitido()) {
					...
					if (documentoRBO != null) {
						...
						if (result) {
							LOGGER.info(i + ") Se actualiz� recibo: " + documentoRBO.getSerie() + documentoRBO.getNumero() + " | NCF: " + documentoNCF.getSerie() + documentoNCF.getNumero()
	...
	public Documento moveToNextDocument(Documento documento) throws PermisosException {
		try {
			...
			if (nextDoc == null) {
				throw new RuntimeException("No se encontr� el documento siguiente.\nEl mismo fu� borrado o no existe.");
			}
	...
	public Documento moveToPrevDocument(Documento documento) throws PermisosException {
		try {
			...
			if (prevDoc == null) {
				throw new RuntimeException("No se encontr� el documento anterior.\nEl mismo fue borrado o no existe.");
			}
