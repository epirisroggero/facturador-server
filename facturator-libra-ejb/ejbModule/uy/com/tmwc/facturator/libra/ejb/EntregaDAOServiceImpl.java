...
public class EntregaDAOServiceImpl extends ServiceBase implements EntregaDAOService {
	...
	public String persist(Entrega e) {
		...
		uy.com.tmwc.facturator.libra.entity.Entrega entregalibra = mapper.map(e,
	...
	public void merge(Entrega e) {
		...
		uy.com.tmwc.facturator.libra.entity.Entrega entrega = mapper.map(e,
				uy.com.tmwc.facturator.libra.entity.Entrega.class);
	...
	public Boolean remove(Entrega e) {
		if (e != null && e.getCodigo() != null) {
			DozerBeanMapper mapper = mapService.getDozerBeanMapper();
			uy.com.tmwc.facturator.libra.entity.Entrega entregaEntity = mapper.map(e,
					uy.com.tmwc.facturator.libra.entity.Entrega.class);
