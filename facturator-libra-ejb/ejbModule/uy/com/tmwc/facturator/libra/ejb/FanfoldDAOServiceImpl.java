...
public class FanfoldDAOServiceImpl extends ServiceBase implements FanfoldDAOService {
	...
	public String persist(Fanfold e) {
		...
		uy.com.tmwc.facturator.libra.entity.Fanfold fanfoldlibra = mapper.map(e,
	...
	public void merge(Fanfold e) {
		...
		uy.com.tmwc.facturator.libra.entity.Fanfold fanfold = mapper.map(e,
				uy.com.tmwc.facturator.libra.entity.Fanfold.class);
	...
	public Boolean remove(Fanfold e) {
		if (e != null && e.getCodigo() != null) {
			DozerBeanMapper mapper = mapService.getDozerBeanMapper();
			uy.com.tmwc.facturator.libra.entity.Fanfold fanfoldEntity = mapper.map(e,
					uy.com.tmwc.facturator.libra.entity.Fanfold.class);
