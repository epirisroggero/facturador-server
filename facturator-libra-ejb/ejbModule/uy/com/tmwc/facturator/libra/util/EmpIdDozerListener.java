...
public class EmpIdDozerListener
  implements DozerEventListener
{
  ...
  private void setEmpId(Object compositeId) {
    try {
      ...
      Method method2 = cidClazz.getMethod("setEmpId", new Class[] { String.class });
      method2.invoke(compositeId, new Object[] { Constantes.getEmpId() });
