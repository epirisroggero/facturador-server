...
@Embeddable
public class DoccuotaPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		return (this.empId.equals(castOther.empId)) && (this.docId == castOther.docId) && (this.cuotaId == castOther.cuotaId);
	}
