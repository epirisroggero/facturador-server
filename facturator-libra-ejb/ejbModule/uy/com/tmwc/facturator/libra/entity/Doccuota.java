...
public class Doccuota extends PersistentEntity<DoccuotaPK>
  implements Serializable, HasId<DoccuotaPK>
{
  ...
  @NotFound(action=NotFoundAction.IGNORE)
  @ManyToOne(optional=false)
  @JoinColumns({@javax.persistence.JoinColumn(name="CuotaMoneda", referencedColumnName="MndId", insertable=false, updatable=false), @javax.persistence.JoinColumn(name="EmpId", referencedColumnName="EmpId", insertable=false, updatable=false)})
