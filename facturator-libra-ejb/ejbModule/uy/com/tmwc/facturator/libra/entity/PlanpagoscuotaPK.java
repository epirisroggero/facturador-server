...
@Embeddable
public class PlanpagoscuotaPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		return (this.empId.equals(castOther.empId)) && (this.PPid.equals(castOther.PPid)) && (this.numero == castOther.numero);
	}
