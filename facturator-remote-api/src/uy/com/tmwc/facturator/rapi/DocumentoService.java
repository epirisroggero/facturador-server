...
public interface DocumentoService {
	...
	BigDecimal getPrecioSugerido(String articulo, String preciosVenta, String monedaFacturacion,
			Cotizaciones oCotizaciones);

	List<AntecedentesArticulo> getAntecedentes(String articulo, String cliente, int limit, boolean venta)
	...
	int modificarCostos(String codart, Date dateDesde, Date dateHasta, RUTINA_MODIFCOSTO_ENUM costoAnterior,
	...
	List<LineaDocumento> getLineasCotizadas(String cliId, String artId, String cmpId, Date fromDate, Date toDate,
			int limit);

	ArticuloPrecio getArticuloPrecio(String articulo, String preciosVenta) throws PermisosException;

	void modificarArticuloPrecio(String codart, String minorista, String industria, String distribuidor)
			throws PermisosException;
